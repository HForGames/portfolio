...
function CardCompetence(props: props) {
    ...
    const style = {"--num": props.value, "--offset": 630 - (630 * (props?.value || 0)) / 100} as React.CSSProperties;
    return (
        <div className={props.className}>
            ...
            {/*    <div className={"percent"} style={style}>*/}
                    ...
                    {/*</svg>*/}
                    <img className={"w-full h-full object-contain"} alt={props.alt} src={props.image}></img>
                {/*</div>*/}
            </div>
        </div>
    )
